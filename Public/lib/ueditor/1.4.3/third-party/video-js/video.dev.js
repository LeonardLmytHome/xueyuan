...
/**
 * Element Data Zhan. Allows for binding data to an element without putting it directly on the element.
...
vjs.Player = vjs.Component.extend({
  ...
  init: function(tag, options, ready){
    this.tag = tag; // Zhan the original tag used to set options
...
vjs.Flash = vjs.MediaTechController.extend({
  ...
  init: function(player, options, ready){
    ...
    var source = options['source'],
        ...
        // Zhan player options in local var for optimization
  ...
  if (this.cues_.length > 0) {
    ...
    if (this.prevChange === undefined || time < this.prevChange || this.nextChange <= time) {
      var cues = this.cues_,
          ...
          newCues = [], // Zhan new active cues.

          // Zhan where in the loop the current active cues are, to provide a smart starting point for the next loop.
