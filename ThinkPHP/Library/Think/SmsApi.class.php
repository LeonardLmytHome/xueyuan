...
class SmsApi{
	...
	const ISENDURL='http://intapi.253.com/mt';//单发接口
...
//		$this->_pw=$password;
	...
	public function sendInternational($phone,$content,$isreport=0){
		...
		$param='un='.$this->_un.'&pw='.$this->_pw.'&sm='.urlencode($content).'&da='.$phone.'&rd='.$isreport.'&rf=1&tf=3';
		$url=SmsApi::ISENDURL.'?'.$param;//单发接口
