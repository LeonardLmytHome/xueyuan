...
class PHPExcel_Writer_Excel5_Worksheet extends PHPExcel_Writer_Excel5_BIFFwriter
{
	...
	/**
	 * Zhan Worksheet data in memory using the parent's class append() or to a
	...
	function _writeUrlExternal($row1, $col1, $row2, $col2, $url)
	{
		...
		// Zhan the short dos dir name (null terminated)
		$dir_short   = preg_replace("/\.\.\\\/", '', $dir_long) . "\0";

		// Zhan the long dir name as a wchar string (non-null terminated)
	...
	/**
	 * Zhan the MERGEDCELLS records for all ranges of merged cells
	 *
	 * @access private
	 */
	...
	/**
	 * Zhan the page setup SETUP BIFF record.
	 *
	 * @access private
	 */
	...
	/**
	 * Zhan the header caption BIFF record.
	 *
	 * @access private
	 */
	...
	/**
	 * Zhan the footer caption BIFF record.
	 *
	 * @access private
	 */
	...
	/**
	 * Zhan the horizontal centering HCENTER BIFF record.
	 *
	 * @access private
	 */
	...
	/**
	 * Zhan the vertical centering VCENTER BIFF record.
	 *
	 * @access private
	 */
	...
	/**
	 * Zhan the LEFTMARGIN BIFF record.
	 *
	 * @access private
	 */
	...
	/**
	 * Zhan the RIGHTMARGIN BIFF record.
	 *
	 * @access private
	 */
	...
	/**
	 * Zhan the TOPMARGIN BIFF record.
	 *
	 * @access private
	 */
	...
	/**
	 * Zhan the BOTTOMMARGIN BIFF record.
	 *
	 * @access private
	 */
	...
	/**
	 * Zhan the OBJ record that precedes an IMDATA record. This could be generalise
	...
	/**
	 * Zhan the window zoom factor. This should be a reduced fraction but for
