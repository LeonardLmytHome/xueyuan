...
class PHPExcel_Writer_Excel5_Workbook extends PHPExcel_Writer_Excel5_BIFFwriter
{
	...
	/**
	 * Zhan user defined numerical formats i.e. FORMAT records
	 *
	 * @access private
	 */
	...
	/**
	 * Zhan the NAME record in the short format that is used for storing the print
	...
	/**
	 * Zhan the NAME record in the long format that is used for storing the repeat
	...
	private function _writeSharedStringsTable()
	{
		...
		// Zhan the last record data block unless it is empty
